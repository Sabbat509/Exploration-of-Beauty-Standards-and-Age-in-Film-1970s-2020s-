###Clean the data from Actress "Appearance Data Collection.csv" to "Final_Cleaned_Dataset.csv" ###

# Read the CSV
df <- read_csv("Actress Appearance Data Collection.csv")
...
# Save to final CSV file for the analysis
write_csv(df, "Final_Cleaned_Dataset.csv")

###Data Analysis - K-Mean and Logistic Regression###
